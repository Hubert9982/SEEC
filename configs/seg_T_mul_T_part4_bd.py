...
from model.distribution.rgb_lmm_bit import RGBMixtureLogisticDiffBitdepth as RGBLMM
...
from model.seec_bitdepth import SeecBitDepthNet as SeecNet
...
ep = EntropyModel(ep_ch_in, ep_ch_out, num_cls=num_cls)
